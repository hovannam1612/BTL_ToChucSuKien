<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ThemTaiKhoan.aspx.cs" Inherits="BTL_ToChucSuKien.Admin.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <asp:Button ID="themTk" Text="Thêm tài khoản" runat="server" OnClick="themTk_Click" />

    <asp:Button ID="dsTk" Text="Danh sách tài khoản" PostBackUrl="~/Admin/QuanLyTaiKhoan.aspx" runat="server" />
    <br />
    <br />
    <br />
